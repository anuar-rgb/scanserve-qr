...
const DARK_VARS = {
  ...
  "--text-muted":     "#9A9A9A",
  "--border-color":   "#3A3A3A",
  "--pill-active-bg": "#E7E9EB",
  "--pill-active-fg": "#242424",
  "--pill-border":    "#404040",
  "--pill-text":      "#9A9A9A",
  "--cta-bg":         "#E7E9EB",
  "--cta-fg":         "#242424",
...
function InfoShowcaseSection({
  ...
  useEffect(() => {
    if (!activeChipId) { setVisible(false); return; }
    let id2: number;
  ...
  return (
    <div style={{ marginBottom: SP.lg }}>
      ...
      {/* ── Inline dropdown — shown when any chip is open ─────────────────────── */}
      {activeChipId && activeItem && (
        <div style={{
          marginTop: 10,
          opacity: visible ? 1 : 0,
